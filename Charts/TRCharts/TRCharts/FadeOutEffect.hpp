...
#ifndef Charts_FadeOutEffect_hpp
#define Charts_FadeOutEffect_hpp
...
namespace Charts
{
	...
	class GeneratedFadeOutEffect : public CodegenSupport::BaseObject, public Charts::AnimationEffect
	{
	public:
		virtual ~GeneratedFadeOutEffect(void);

		std::shared_ptr<FadeOutEffect> getSharedPtr(void);

		std::shared_ptr<const FadeOutEffect> getSharedPtr(void) const;
