...
#include <TRChartsJNI/SteppedAreaSeries.hpp>
...
JNIEXPORT jlong JNICALL Java_com_thomsonreuters_corptech_charts_SteppedAreaSeries_nativeCreate(JNIEnv *env, jobject obj)
{
	try {
		Utils::threadEnter(env);
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		Charts::SteppedAreaSeries * const nativeObject = new Charts::SteppedAreaSeries();
...
JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_SteppedAreaSeries_nativeDestroy(JNIEnv *env, jobject obj, jlong ptr)
{
	try {
		Utils::threadEnter(env);
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
