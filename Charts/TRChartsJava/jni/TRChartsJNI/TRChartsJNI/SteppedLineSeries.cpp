...
#include <TRChartsJNI/SteppedLineSeries.hpp>
...
JNIEXPORT jlong JNICALL Java_com_thomsonreuters_corptech_charts_SteppedLineSeries_nativeCreate(JNIEnv *env, jobject obj)
{
	try {
		Utils::threadEnter(env);
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		Charts::SteppedLineSeries * const nativeObject = new Charts::SteppedLineSeries();
...
JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_SteppedLineSeries_nativeDestroy(JNIEnv *env, jobject obj, jlong ptr)
{
	try {
		Utils::threadEnter(env);
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
