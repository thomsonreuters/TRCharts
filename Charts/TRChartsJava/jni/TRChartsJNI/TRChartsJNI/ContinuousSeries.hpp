...
#ifndef TRChartsJNI_ContinuousSeries_hpp
#define TRChartsJNI_ContinuousSeries_hpp
...
JNIEXPORT jobject JNICALL Java_com_thomsonreuters_corptech_charts_ContinuousSeries_nativeGetDataSource(JNIEnv * env, jobject obj, jlong ptr);

JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_ContinuousSeries_nativeSetDataSource(JNIEnv * env, jobject obj, jlong ptr, jobject value);
...
JNIEXPORT jobject JNICALL Java_com_thomsonreuters_corptech_charts_ContinuousSeries_nativeGetDatum(JNIEnv * env, jobject obj, jlong ptr, jlong index);

JNIEXPORT jobject JNICALL Java_com_thomsonreuters_corptech_charts_ContinuousSeries_nativeInterpolateDatum(JNIEnv * env, jobject obj, jlong ptr, jdouble abscissa);
