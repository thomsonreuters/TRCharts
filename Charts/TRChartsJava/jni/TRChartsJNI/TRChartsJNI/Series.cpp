...
#include <TRChartsJNI/Series.hpp>
...
JNIEXPORT jobject JNICALL Java_com_thomsonreuters_corptech_charts_Series_nativeGetOrdinateAxis(JNIEnv * env, jobject obj, jlong ptr)
{
	try {
		...
		return TRChartsJNI::getContinuousAxisMarshaller().unmarshall(env, handle->getNativeObject<Charts::Series>(env)->getOrdinateAxis());
...
JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_Series_nativeSetOrdinateAxis(JNIEnv * env, jobject obj, jlong ptr, jobject value)
{
	try {
		...
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		TRChartsJNI::Handle * const handle = reinterpret_cast<TRChartsJNI::Handle *>(ptr);
		handle->getNativeObject<Charts::Series>(env)->setOrdinateAxis(TRChartsJNI::getContinuousAxisMarshaller().marshall(env, value));
	} catch (const std::exception & e) {
		Utils::throwJavaException(env, e.what());
	} catch (...) {
		Utils::throwJavaException(env, nullptr);
...
JNIEXPORT jobject JNICALL Java_com_thomsonreuters_corptech_charts_Series_nativeGetColor(JNIEnv * env, jobject obj, jlong ptr)
{
	try {
		...
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		TRChartsJNI::Handle * const handle = reinterpret_cast<TRChartsJNI::Handle *>(ptr);
		return TRChartsJNI::getColorMarshaller().unmarshall(env, handle->getNativeObject<Charts::Series>(env)->getColor());
	} catch (const std::exception & e) {
		Utils::throwJavaException(env, e.what());
	} catch (...) {
		Utils::throwJavaException(env, nullptr);
...
JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_Series_nativeSetColor(JNIEnv * env, jobject obj, jlong ptr, jobject value)
{
	try {
		...
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		TRChartsJNI::Handle * const handle = reinterpret_cast<TRChartsJNI::Handle *>(ptr);
		handle->getNativeObject<Charts::Series>(env)->setColor(TRChartsJNI::getColorMarshaller().marshall(env, value));
	} catch (const std::exception & e) {
		Utils::throwJavaException(env, e.what());
	} catch (...) {
		Utils::throwJavaException(env, nullptr);
...
JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_Series_nativeMarkDirty(JNIEnv * env, jobject obj, jlong ptr)
{
	try {
		...
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		TRChartsJNI::Handle * const handle = reinterpret_cast<TRChartsJNI::Handle *>(ptr);
		handle->getNativeObject<Charts::Series>(env)->markDirty();
	} catch (const std::exception & e) {
		Utils::throwJavaException(env, e.what());
	} catch (...) {
		Utils::throwJavaException(env, nullptr);
...
JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_Series_nativeMarkRangeDirty(JNIEnv * env, jobject obj, jlong ptr, jobject range)
{
	try {
		...
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		TRChartsJNI::Handle * const handle = reinterpret_cast<TRChartsJNI::Handle *>(ptr);
		handle->getNativeObject<Charts::Series>(env)->markRangeDirty(TRChartsJNI::getIndexRangeMarshaller().marshall(env, range));
	} catch (const std::exception & e) {
		Utils::throwJavaException(env, e.what());
	} catch (...) {
		Utils::throwJavaException(env, nullptr);
