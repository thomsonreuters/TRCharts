...
#include <TRChartsJNI/CategoryAxis.hpp>
...
JNIEXPORT jlong JNICALL Java_com_thomsonreuters_corptech_charts_CategoryAxis_nativeCreate(JNIEnv *env, jobject obj)
{
	try {
		Utils::threadEnter(env);
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
		Charts::CategoryAxis * const nativeObject = new Charts::CategoryAxis();
...
JNIEXPORT void JNICALL Java_com_thomsonreuters_corptech_charts_CategoryAxis_nativeDestroy(JNIEnv *env, jobject obj, jlong ptr)
{
	try {
		Utils::threadEnter(env);
		Utils::EndScopeAction threadExitAction(Utils::threadExit);
