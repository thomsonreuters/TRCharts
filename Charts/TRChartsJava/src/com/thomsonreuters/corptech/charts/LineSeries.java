...
public class LineSeries extends ContinuousSeries<ScalarDatum>
{
	/**
	 * Default constructor
	 */
	...
	public LineStyleSource getLineStyleSource()
	{
		return (LineStyleSource)nativeGetLineStyleSource(getHandle());
	}

	/**
	 * Set the line style source.
	 * <p>
	 * May optionally be provided, to control the per-datum line style.
	 * </p>
	 * @see LineStyleSource
	...
	public void setLineStyleSource(final LineStyleSource value)
	{
		nativeSetLineStyleSource(getHandle(), value);
	}
	...
	/*package*/ LineSeries(boolean dummy)
	{
		super(dummy);
	}
	...
	private final native Object nativeGetLineStyleSource(long ptr);
	private final native void nativeSetLineStyleSource(long ptr, Object value);
