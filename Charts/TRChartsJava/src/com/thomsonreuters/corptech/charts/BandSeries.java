...
/**
 * <p>
 * A series that displays range datums as a band.
 * </p>
 * <p>
...
public class BandSeries extends ContinuousSeries<RangeDatum>
{
	/**
	 * Default constructor
	 */
	...
	public ContinuousDataSource<RangeDatum> getDataSource()
	{
		return (ContinuousDataSource<RangeDatum>)nativeGetDataSource(getHandle());
	}
	...
	public void setDataSource(final ContinuousDataSource<RangeDatum> value)
	{
	...
	public RangeDatum getDatum(final long index)
	{
		return (RangeDatum)nativeGetDatum(getHandle(), index);
	}
	...
	public RangeDatum interpolateDatum(final double abscissa)
	{
		return (RangeDatum)nativeInterpolateDatum(getHandle(), abscissa);
	}

	// need this to prevent default constructor in base classes
	/*package*/ BandSeries(boolean dummy)
	{
		super(dummy);
	}
