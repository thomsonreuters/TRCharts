...
#import <TRChartsObjc/RangeFittingAxisLayout.h>
#import "TestUtils.hh"

#import <XCTest/XCTestAssertions.h>

@implementation TRRangeFittingAxisLayoutGeneratedTests
...
-(id)createInstance
{
	return [[TRRangeFittingAxisLayout alloc] init];
}

- (void) testInitializeFieldRangeCalculator
{
	TRRangeFittingAxisLayout * instance = [self createInstance];
	if(instance) {
