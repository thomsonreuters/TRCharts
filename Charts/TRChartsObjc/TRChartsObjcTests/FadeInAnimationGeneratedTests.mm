...
#import <TRChartsObjc/FadeInAnimation.h>
#import "TestUtils.hh"

#import <XCTest/XCTestAssertions.h>

@implementation TRFadeInAnimationGeneratedTests
...
-(id)createInstance
{
	return [[TRFadeInAnimation alloc] init];
}

- (void) testInitializeFieldDrawableList
{
	TRFadeInAnimation * instance = [self createInstance];
	if(instance) {
		NSArray * expected = @[];
