...
#import <TRCharts/SteppedAreaSeries.hpp>

#import <TRChartsObjc/Support/Marshallers.hh>
#import <TRCodegenSupportObjc/Handle.hh>

@implementation TRSteppedAreaSeries

-(TRSteppedAreaSeries*)init {
	TRChartsObjc::verifyCurrentQueue();
	self = [super initConcrete];
	Charts::SteppedAreaSeries * const obj = new Charts::SteppedAreaSeries();
