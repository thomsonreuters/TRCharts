...
#import <TRCharts/SteppedLineSeries.hpp>

#import <TRChartsObjc/Support/Marshallers.hh>
#import <TRCodegenSupportObjc/Handle.hh>

@implementation TRSteppedLineSeries

-(TRSteppedLineSeries*)init {
	TRChartsObjc::verifyCurrentQueue();
	self = [super initConcrete];
	Charts::SteppedLineSeries * const obj = new Charts::SteppedLineSeries();
