...
void TRChartsObjc::markQueue(dispatch_queue_t queue)
{
	dispatch_queue_set_specific(queue, queueKey, queueValue, nullptr);
}

void TRChartsObjc::unmarkQueue(dispatch_queue_t queue)
{
	dispatch_queue_set_specific(queue, queueKey, nullptr, nullptr);
}

bool TRChartsObjc::isQueueMarked(void)
{
	return (dispatch_get_specific(queueKey) == queueValue);
}

void TRChartsObjc::enableQueueVerification(bool yes)
{
	queueVerificationEnabled = yes;
}

void TRChartsObjc::verifyCurrentQueue(void)
{
