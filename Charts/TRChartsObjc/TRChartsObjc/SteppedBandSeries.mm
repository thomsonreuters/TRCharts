...
#import <TRCharts/SteppedBandSeries.hpp>

#import <TRChartsObjc/Support/Marshallers.hh>
#import <TRCodegenSupportObjc/Handle.hh>

@implementation TRSteppedBandSeries

-(TRSteppedBandSeries*)init {
	TRChartsObjc::verifyCurrentQueue();
	self = [super initConcrete];
	Charts::SteppedBandSeries * const obj = new Charts::SteppedBandSeries();
