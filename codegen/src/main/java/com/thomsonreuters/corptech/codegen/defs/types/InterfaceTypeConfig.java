...
import com.thomsonreuters.corptech.codegen.defs.InterfaceDef;
...
public class InterfaceTypeConfig extends TypeConfig
{
	@Getter
	@Nonnull
	private InterfaceDef interfaceDef;

	public InterfaceTypeConfig(@Nonnull final InterfaceDef interfaceDef)
	{
	...
	{
		return interfaceDef.getName();
	}

	@Override
	public String getJavaType()
	{
		return interfaceDef.getJavaClassname();
	}
	...
	{
		return interfaceDef.getCppNamespacedClassname();
	}
	...
	{
		return interfaceDef.getName() + "InterfaceMarshaller()";
	}
	...
	{
		return interfaceDef.resolveVariable("objcSupportNamespace") + "::" + interfaceDef.getName() + "InterfaceMarshaller()";
	}
	...
	{
		return Collections.<TopLevelDef>singleton(interfaceDef);
	}
