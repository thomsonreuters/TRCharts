...
import com.thomsonreuters.corptech.codegen.defs.types.TemplateInterfaceTypeConfig;
...
public class TemplateInterfaceDef extends InterfaceDef
{
	...
	public TypeConfig createTypeConfig(final TypeConfig... templateArgs)
	{
		...
		return new TemplateInterfaceTypeConfig(this, templateArgs);
	}
