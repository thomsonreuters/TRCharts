...
public class TemplateClassDef extends ClassDef
{
	...
	public TypeConfig createTypeConfig(final TypeConfig... templateArgs)
	{
		...
		return new TemplateClassTypeConfig(this, templateArgs);
	}

	@AssertTrue(message = "Template class must not be concrete")
